...
def harryresults():
    ok_file_path = '/sdcard/NISHANT/NISHANT-OK.txt'
    cp_file_path = '/sdcard/NISHANT/NISHANT-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100081615768315&mibextid=ZbWKwL')
...
def setting():
	...
	linex()
	hu = input(' \x1b[38;5;196m[\x1b[37m•\x1b[38;5;196m]\x1b[37m CHOOSE METHOD: ')
	if hu in ['1','01']:
...
def passwrd():
	...
	banner()
	info()
	print(f' \x1b[38;5;196m[\x1b[37m•\x1b[38;5;196m]\x1b[37m TOTAL SCANABLE IDS    :',str(len(id)))
	print(" \x1b[37m\x1b[38;5;196m[\x1b[37m•\x1b[38;5;196m]\x1b[37m YOU STARTED CLONING AT THIS TIME 👉: "+time.strftime("%H:%M")+" "+ tag)
	linex()
	print(f' \x1b[38;5;196m>>\x1b[37m USE FLIGHT MODE (AEROPLANE MODE) EVERY 1000 IDS ')
	linex()
